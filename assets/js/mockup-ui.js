...
export function shell(s,content,{resident=false,superAdmin=false,title=''}={}) {
  ...
  const links=superAdmin?[['dashboard','Dashboard','home'],['companies','Empresas gestoras','buildings']]:resident?sidebarMenu.filter(([id])=>!['suppliers','reports'].includes(id)):sidebarMenu;
